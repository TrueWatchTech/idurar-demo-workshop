...
datafluxRum.init({
    ...
    allowedTracingOrigins: [/^http:\/\/.*\.elb\.ap-southeast-1\.amazonaws\.com(:\d+)?$/i],  // Not required; allow all requests to be injected into the header required by the trace collector. It can be the origin of the request or it can be regular.
});
